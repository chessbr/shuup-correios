...
class AbstractPackage(object):
    ...
    def cubic_weight(self):
        """
        Calculates and return the cubic weight.
        Implement this in your subclass for custom package
        :rtype: decimal.Decimal
        """
        raise NotImplementedError("Implement this method")
...
class BasePackage(AbstractPackage):
    ...
    def __init__(self, package_constraint=None):
        self._constraint = package_constraint
    ...
    def __repr__(self, *args, **kwargs):
        return "<Package: items:{0}, width={1}mm, "\
               ...
               "weight={4}g, constraint={5}>".format(self.count,
                                                    self.width,
                                                    self.height,
                                                    self.length,
                                                    self.weight,
