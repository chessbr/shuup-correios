...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ('servicebehaviorcomponent_ptr', models.OneToOneField(parent_link=True, serialize=False, primary_key=True, to='shuup.ServiceBehaviorComponent', auto_created=True)),
                ...
                ('max_weight', shuup.core.fields.MeasurementField(max_digits=36, decimal_places=9, verbose_name='Peso máximo', help_text='Indica o peso máximo admitido para esta modalidade.', default=Decimal('0'), unit='g', validators=[django.core.validators.MinValueValidator(Decimal('0'))], blank=True)),
                ('min_length', shuup.core.fields.MeasurementField(decimal_places=9, max_digits=36, help_text='Indica o comprimento mínimo para caixas e pacotes.', default=160, unit='mm', verbose_name='Comprimento mínimo', validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('max_length', shuup.core.fields.MeasurementField(decimal_places=9, max_digits=36, help_text='Indica o comprimento máximo para caixas e pacotes.', default=1050, unit='mm', verbose_name='Comprimento máximo', validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('min_width', shuup.core.fields.MeasurementField(decimal_places=9, max_digits=36, help_text='Indica a largura mínima para caixas e pacotes.', default=110, unit='mm', verbose_name='Largura mínima', validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('max_width', shuup.core.fields.MeasurementField(decimal_places=9, max_digits=36, help_text='Indica a largura máxima para caixas e pacotes.', default=1050, unit='mm', verbose_name='Largura máxima', validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('min_height', shuup.core.fields.MeasurementField(decimal_places=9, max_digits=36, help_text='Indica a altura mínima para caixas e pacotes.', default=200, unit='mm', verbose_name='Altura mínima', validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('max_height', shuup.core.fields.MeasurementField(decimal_places=9, max_digits=36, help_text='Indica a altura máxima para caixas e pacotes.', default=1050, unit='mm', verbose_name='Altura máxima', validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
                ('max_edges_sum', shuup.core.fields.MeasurementField(decimal_places=9, max_digits=36, help_text='Indica a soma máxima das dimensões de altura + largura + comprimento para caixas e pacotes.', default=2000, unit='mm', verbose_name='Soma máxima das dimensões (L + A + C)', validators=[django.core.validators.MinValueValidator(Decimal('0'))])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('carrier_ptr', models.OneToOneField(parent_link=True, serialize=False, primary_key=True, to='shuup.Carrier', auto_created=True)),
            ],
            options={
